    ...
    <div class="row page-padding px-5">
        <div class="col-md-3 ps-3">
                ...
                <nav class="nav nav-pills bg-light flex-column overflow-auto" style="border:1.5px solid black;border-radius:10px">
                    ...
                    <a class="nav-link link-dark table-heading py-1" href="#scrollspyVoronoiIntro">Introduction</a>
                    <a class="nav-link link-dark table-heading py-1" href="#scrollspyVoronoiResult">Result</a>
                </nav>
                </div>
                </div>
        </div>
                ...
                <div class="col-md-9">
                    <div class="article-padding my-3">
                        <article class="markdown" data-bs-target="#navbar-toc" data-bs-offset="0" tabindex="0">
                            <h1 class="project-big-title">Fast Neighbour Relation Extraction in Occupancy Grid Map using Voronoi Diagram</h1>
                            <p class="lead py-3">
                            ...
                            <h2 id="scrollspyVoronoiIntro" class="scroll-heading">Introduction</h2>
                            <p>
                                "This tutorial simply shows how to configure and open the ZED, print its serial number and close the camera. This is the most basic tutorial and a good start for using the ZED SDK."   
                            </p>
                            <p>
                            ...
                            <h2 id="scrollspyVoronoiResult" class="scroll-heading">Result</h2>
                            <p>
                                "This tutorial simply shows how to configure and open the ZED, print its serial number and close the camera. This is the most basic tutorial and a good start for using the ZED SDK."   
                            </p>
                            <p>
