...
<head>
    ...
    <title>Jingxue Jiang's About Page</title>
    <meta name="description" content="The about page includes an short introduction about myself and a professional photo">
...
<body>
    <header class="sticky-top">
            <div class="master p-3" style="background:white">
