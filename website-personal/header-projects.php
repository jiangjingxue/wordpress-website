...
<head>
    ...
    <title>Jingxue Jiang's Projects Page</title>
    <meta name="description" content="The project page lists all projects Jingxue Jiang has taken on">
...
<body>
    ...
    <header class="sticky-top">
            <div class="master p-3" id="mbackgroundmaster" style="background:#efefef">
                <div class="master-inner px-5">
                    <nav class="site-nav navbar navbar-expand-lg navbar-light">
                        <div class="site-nav-inner container-fluid px-4">
                            ...
                            <button type="button" class="btn btn-outline-light rounded-pill navbar-mode" id="modebuttonproject">Mode</button>
        ...
        <!-- <div class="master">
            <div class="master-inner">
                <nav class="site-nav navbar navbar-expand-lg navbar-light px-5">
                    <div class="site-nav-inner container-fluid">
                        <a class="site-title navbar-brand" href="<?php echo site_url(''); ?>">Jiang</a>
                        <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarToggler" aria-controls="navbarToggler" aria-expanded="false" aria-label="Toggle navigation" style="background:#E1C16E">
                            <span class="navbar-toggler-icon"></span>
                        </button>
                        <div class="collapse navbar-collapse justify-content-end" id="navbarToggler">
